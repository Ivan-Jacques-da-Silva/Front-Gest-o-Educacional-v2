...
const menuItems = [
    ...
    { texto: "Cursos", icone: "fa-solid:book", classe: "bg-orange", to: "/cursos", permissoes: [1, 2, 4] },
    { texto: "Turmas", icone: "gridicons:multiple-users", classe: "bg-cyan", to: "/turmas", permissoes: [1, 2, 3, 4, 5] },
    { texto: "Chamada", icone: "fa-solid:clipboard-list", classe: "bg-pink", to: "/chamada", permissoes: [1, 2, 3, 4, 5] },
